<script lang="ts">
    ...
    async function injectContentIntoIframe(term: string): Promise<void> {
        ...
        const iframeContent = `
            ...
            <body data-language="${$page.data?.targetLang.nameEN}" class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject mw-editable page-tle rootpage-tle stable issues-group-B skin-minerva action-view skin--responsive mw-mf-amc-disabled mw-mf minerva-animations-ready">
